...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($httpCode === 200 || $httpCode === 204) {
        ...
        header("Location: project-categories.php?error=" . urlencode("Failed to update category. HTTP Code: " . $httpCode));
        exit();
    }
}
...
<div class="container-fluid">
    ...
    <?php if (!$is_found): ?>
        <div class="alert alert-info shadow-sm" style="max-width: 600px;">
            ...
            <p class="mb-3">The project category with ID #<?php echo $id; ?> cannot be edited because it does not exist.</p>
            <hr>
    ...
    <?php else: ?>
        <div class="card shadow-sm" style="max-width: 600px;">
            ...
            <form action="project-category-edit.php?id=<?php echo $category['id']; ?>" method="POST">
